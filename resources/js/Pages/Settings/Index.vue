...
const sections = [
    {
        label: __('Venue Info'),
        description: __('Name, address, contact and call waiter settings.'),
        routeName: 'settings.venue',
        icon: 'M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z',
    },
    {
        label: __('General'),
        description: __('Cover charge, service fee and table count.'),
    ...
    {
        label: __('Kitchen Stations'),
        description: __('Manage stations to route items to the right preparation area.'),
    ...
    {
        label: __('Preparation Statuses'),
        description: __('Define stages items go through from received to ready.'),
        routeName: 'settings.preparation-statuses.index',
        icon: 'M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z',
    },
    {
        label: __('Service Locations'),
        description: __('Tables, counters and other areas served by your venue.'),
