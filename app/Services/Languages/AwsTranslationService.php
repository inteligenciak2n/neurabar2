...
class AwsTranslationService
{
     ...
     *
     * @param  array  $texts  Textos no idioma fonte para traduzir
     * @param  array  $targetLanguages  Idiomas de destino ['pt', 'es']
     * @param  string  $sourceLang  Idioma fonte
     * @return array Traduções organizadas por idioma
     */
    public function translateTexts(array $texts, array $targetLanguages = ['pt', 'es'], string $sourceLang = 'en'): array
    {
     ...
     *
     * @param  array  $data  Dados no idioma fonte
     * @param  array  $targetLanguages  Idiomas de destino
     * @param  string  $sourceLang  Idioma fonte
     * @return array Traduções organizadas por idioma
     */
    public function translateNestedData(array $data, array $targetLanguages = ['pt', 'es'], string $sourceLang = 'en'): array
    {
        ...
        $translations = $this->translateTexts($flatTexts, $targetLanguages, $sourceLang);
